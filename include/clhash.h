/* Code from: https://github.com/simdhash/clhash/tree/master
 *
 * CLHash is a very fast hashing function that uses the
 * carry-less multiplication and SSE instructions.
 *
 * Daniel Lemire, Owen Kaser, Faster 64-bit universal hashing using carry-less 
 *      multiplications, Journal of Cryptographic Engineering 6 (3), 2016. 
